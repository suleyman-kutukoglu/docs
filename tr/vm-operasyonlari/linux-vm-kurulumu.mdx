---
title: "Linux VM Oluşturma ve Erişim"
---

Zadara Edge Cloud üzerinde **mevcut bir Linux imajından** (ör. _Ubuntu 24.04 LTS_) VM oluşturmak ve erişim sağlamak için aşağıdaki adımları izleyin.
...
Security Group’lar hakkında kapsamlı bilgi için [Security Group Yönetimi](/tr/network/security-groups) dokümanına göz atabilirsiniz.
