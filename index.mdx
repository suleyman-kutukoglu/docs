  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard
        ...
        description="Dakikalar içinde ilk projenizi oluşturun, kullanıcı ve kaynak atamalarını tamamlayın."
      ...
      <HeroCard
        ...
        description="VM, dosya ve veritabanı yedekleri; saklama politikaları ve hızlı geri dönüş."
